...
const judithImage = "/assets/0781dbd8f8e47b7b7a2635ca5190583ab69776e2.png";
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="mb-16">
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-r from-[#177F00] to-[#E99C00] rounded-2xl p-8 text-white">
                  <p className="text-2xl font-bold mb-4">Kuleta was created to change that.</p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-100 hover:border-[#177F00] transition-all">
                    <div className="flex flex-col items-center text-center mb-6">
                      <ImageWithFallback src={mandaImage} alt="Manda Bwerevu" className="w-32 h-32 rounded-full object-cover border-4 border-[#177F00] mb-4" />
                ...
                <div className="group relative">
                  ...
                  <div className="relative bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-100 hover:border-[#E99C00] transition-all">
                    <div className="flex flex-col items-center text-center mb-6">
                      <ImageWithFallback src={judithImage} alt="Judith" className="w-32 h-32 rounded-full object-cover border-4 border-[#E99C00] mb-4" />
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-700 leading-relaxed">To deliver authentic, high-quality African products to global consumers through a trusted marketplace connecting customers directly to women-led businesses, ensuring fair value, reliable delivery, and meaningful impact with every purchase.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
              <h3 className="text-2xl font-semibold mb-4 text-[#E99C00]">Our Vision</h3>
              <p className="text-gray-700 leading-relaxed">A global marketplace where customers everywhere can easily access authentic African goods they trust, through expanded market reach, sustainable income, and long-term economic opportunity.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl text-center mb-12 bg-gradient-to-r from-[#177F00] to-[#E99C00] bg-clip-text text-transparent">Our Values</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value) => (
              <div key={value.title} className="text-center p-6 bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 bg-gradient-to-r from-[#177F00] to-[#E99C00]">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 text-center text-white">
            <div><div className="text-5xl font-bold mb-2">500+</div><div className="text-lg opacity-90">Women Vendors Supported</div></div>
            <div><div className="text-5xl font-bold mb-2">10+</div><div className="text-lg opacity-90">Markets We Source From</div></div>
            <div><div className="text-5xl font-bold mb-2">7 days</div><div className="text-lg opacity-90">Average Delivery Time</div></div>
          </div>
        </div>
      </section>
